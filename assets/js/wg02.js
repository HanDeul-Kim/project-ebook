...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg02/pteranodon.glb'
modelScale = 0.7
modelPos = { x: 0.1, y: -0.85, z: 0 }
camInitPos = { x: 5.5, y: 0.5, z: -0.5 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: -0.5, y: -0.2, z: 1}, { x: 6, y: 0, z: 5 }, 3) //날개
addBtnFn('02', '', { x: -0.1, y: -0.2, z: -1 }, { x: 5, y: 0, z: 6 }, 4) //날개 손 
addBtnFn('03', '', { x: 0, y: 0, z: 0 }, { x: 6, y: 0, z: -4 }, 2) //뼈
addBtnFn('04', '', { x: 1, y: -0.3, z: 0 }, { x: 7, y: 0, z: -0.2 }, 1) //부리
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
