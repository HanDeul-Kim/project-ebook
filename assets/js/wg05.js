...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg05/brachiosaurus.glb'
modelScale = 0.25
modelPos = { x: 0.1, y: -1.7, z: 0 }
camInitPos = { x: 5, y: -0.5, z: -5 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 0.7, y: 1.3, z: 0}, { x: 7, y: 0, z: -1 }, 1) ////머리
addBtnFn('02', '', { x: 0.2, y: -0.9, z: 0}, { x: 6, y: 0, z: 6 }, 2) ////배
addBtnFn('03', '', { x: 0, y: -0.5, z: 0 }, { x: 6, y: 0, z: -4 }, 3) ///위
addBtnFn('04', '', { x: 0.4, y: -1.5, z: -0.5 }, { x: 6, y: 0, z: 2 }, 4) ////앞다리
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
...
function resizeFn() {
    if (parent.matchMedia('(orientation: landscape)').matches) {
        if (innerHeight < 300) camera.zoom = 1.3
        else if (innerHeight < 400) camera.zoom = 1.1
        else if (innerHeight < 500) camera.zoom = 1.1
