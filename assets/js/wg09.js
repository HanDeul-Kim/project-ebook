...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg09/velociraptor.glb'
modelScale = 1.8
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 1, y: -0.5, z: 0 }, { x: 6, y: 0, z: -1 }, 3) ////앞다리
addBtnFn('02', '', { x: -1, y: 0, z: 0 }, { x: 5, y: 0, z: 6 }, 1) ////꼬리
addBtnFn('03', '', { x: 0.4, y: 0.8, z: 0 }, { x: 6, y: 0, z: 1 }, 2) ////입
addBtnFn('04', '', { x: 0, y: -1.2, z: 0 }, { x: 5, y: 0, z: 0 }, 4) ////뒷다리
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
