...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg10/archeopteryx.glb'
modelScale = 5
modelPos = { x: 0.1, y: -1.2, z: 0 }
camInitPos = { x: 5.5, y: -1, z: -0.75 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 0, y: -0.5, z: 1 }, { x: 6, y: 0, z: 5 }, 2) //날개
addBtnFn('02', '', { x: -0.8, y: 0, z: 0 }, { x: 5, y: 0, z: 6 }, 4)  //꼬리
addBtnFn('03', '', { x: 0.5, y: -0.9, z: 0 }, { x: 6, y: 0, z: 1 }, 3) //\머리
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
