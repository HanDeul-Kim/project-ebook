...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg03/allosaurus.glb'
modelScale = 0.5
modelPos = { x: -0.1, y: -1.3, z: 0 }
camInitPos = { x: 5.5, y: 0, z: -2.5 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 1.5, y: 0.75, z: 0 }, { x: 6, y: 0, z: 5 }, 1) ////머리
addBtnFn('02', '', { x: 2, y: 0.5, z: 0 }, { x: 6, y: -1, z: -0.2 }, 2) ////이빨
addBtnFn('03', '', { x: -0.2, y: -0.75, z: -0.5 }, { x: 6, y: 0, z: -4 }, 3) //// 뒷다리
addBtnFn('04', '', { x: -2, y: -0.3, z: 0 }, { x: 5, y: 0, z: 2 }, 4) /// 꼬리
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
