...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg07/triceratops.glb'
modelScale = 0.59
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 0.6, y: 0.85, z: 0}, { x: 6, y: 0, z: 5 }, 1) /////프릴
addBtnFn('02', '', {  x: 1.5, y: -0.2, z: 0}, { x: 5, y: 0, z: 6 }, 3) ////이빨
addBtnFn('03', '', { x: 1.75, y: -0.5, z: -0.2 }, { x: 6, y: 0, z: -1 }, 2)  ////입
addBtnFn('04', '', { x: 1.3, y: 0.5, z: 0}, { x: 7, y: 0, z: 2 }, 4) ////얼굴 뿔
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
