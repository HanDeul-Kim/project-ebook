...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg06/ankylosaurus.glb'
modelScale = 0.57
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 0, y: 0.5, z: 0 }, { x: 6, y: 0, z: 1.5 }, 4) /////등
addBtnFn('02', '', { x: -1, y: -0.2, z: 0 }, { x: 5, y: 0, z: 6 }, 2) ////꼬리
addBtnFn('03', '', { x: 1.75, y: -0.2, z: 0 }, { x: 5, y: 0, z: -6 }, 3)  ////입
addBtnFn('04', '', { x: 1.3, y: 0.2, z: 0}, { x: 6, y: -0.5, z: -0.5 }, 1) ////얼굴 뿔
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
