...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg04/stegosaurus.glb'
modelScale = 0.5
modelPos = { x: -0.1, y: -1.1, z: 0 }
camInitPos = { x: 5.5, y: -0.5, z: -1.75 }
anyNum = 0
//* ===================================================================
//*                               Main                                 
//* ===================================================================
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 0, y: 1, z: 0 }, { x: 6, y: 0, z: 5 }, 1) //// 골판
addBtnFn('02', '', { x: 2.0, y: -0.15, z: 0 }, { x: 6, y: -0.5, z: -0.2 }, 2) ////입
addBtnFn('03', '', { x: 0.8, y: -0.6, z: -0.5 }, { x: 6, y: 0, z: 2 }, 4) ///앞다리
addBtnFn('04', '', { x: 2.0, y: -0.3, z: -0.25 }, { x: 5, y: 0, z: -6 }, 3) ///볼
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
export function initialFn() {
    ...
    scene.add(hLight)
    dLight = new THREE.DirectionalLight('#fff', 2)
