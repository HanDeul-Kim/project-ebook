...
targetElem = '#canvas'
//- ----------------------------- model -------------------------------
modelFile = './assets/model/wg08/pachycephalosaurus.glb'
modelScale = 0.8
...
btnNodes = []
btnObjs = []
addBtnFn('01', '', { x: 0.4, y: 0, z: 0}, { x: 6, y: 0, z: 5 }, 3) ////앞다리
addBtnFn('02', '', { x: 0, y: -0.4, z: 0 }, { x: 6, y: 0, z: 1.5 }, 4) ////뒷다리
addBtnFn('03', '', { x: 0.5, y: 0.75, z: 0  }, { x: 6, y: 0, z: -1 }, 1) /////눈
//* ===================================================================
//*                               Core                                 
//* ===================================================================
//- --------------------------- initialFn -----------------------------
